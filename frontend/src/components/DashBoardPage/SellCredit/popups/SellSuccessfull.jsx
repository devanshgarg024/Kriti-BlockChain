  ...
  return (
    <>
      ...
      <div className="popup-title-parent">
        ...
        <p className="popup-subtitle">Youre order has been successful</p>
      </div>
      ...
      <div className="ConfirmCredit-details">
        ...
        <h3>
          ...
          {props.amountToSell} CCT = <img src={ethsvg} width="16" height="16" />{" "}
          {(() => {
            const [base, exponent] =
              (props.amountToSell * props.userppt).toExponential(5).split("e");
            return (
              <>
